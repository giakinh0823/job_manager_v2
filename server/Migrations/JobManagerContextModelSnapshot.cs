...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("server.Entity.Job", b =>
                {
            ...
            modelBuilder.Entity("server.Entity.Log", b =>
                {
            ...
            modelBuilder.Entity("server.Entity.PaymentInfo", b =>
                {
            ...
            modelBuilder.Entity("server.Entity.QrtzBlobTrigger", b =>
                {
            ...
            modelBuilder.Entity("server.Entity.QrtzCalendar", b =>
                {
                    b.Property<string>("SchedName")
                        .HasMaxLength(120)
                        .HasColumnType("nvarchar(120)")
            ...
            modelBuilder.Entity("server.Entity.QrtzCronTrigger", b =>
                {
                    b.Property<string>("SchedName")
                        .HasMaxLength(120)
                        .HasColumnType("nvarchar(120)")
            ...
            modelBuilder.Entity("server.Entity.QrtzFiredTrigger", b =>
                {
                    b.Property<string>("SchedName")
                        .HasMaxLength(120)
                        .HasColumnType("nvarchar(120)")
            ...
            modelBuilder.Entity("server.Entity.QrtzJobDetail", b =>
                {
                    b.Property<string>("SchedName")
                        .HasMaxLength(120)
                        .HasColumnType("nvarchar(120)")
            ...
            modelBuilder.Entity("server.Entity.QrtzLock", b =>
                {
                    b.Property<string>("SchedName")
                        .HasMaxLength(120)
                        .HasColumnType("nvarchar(120)")
            ...
            modelBuilder.Entity("server.Entity.QrtzPausedTriggerGrp", b =>
                {
                    b.Property<string>("SchedName")
                        .HasMaxLength(120)
                        .HasColumnType("nvarchar(120)")
            ...
            modelBuilder.Entity("server.Entity.QrtzSchedulerState", b =>
                {
                    b.Property<string>("SchedName")
                        .HasMaxLength(120)
                        .HasColumnType("nvarchar(120)")
            ...
            modelBuilder.Entity("server.Entity.QrtzSimpleTrigger", b =>
                {
                    b.Property<string>("SchedName")
                        .HasMaxLength(120)
                        .HasColumnType("nvarchar(120)")
            ...
            modelBuilder.Entity("server.Entity.QrtzSimpropTrigger", b =>
                {
                    b.Property<string>("SchedName")
                        .HasMaxLength(120)
                        .HasColumnType("nvarchar(120)")
            ...
            modelBuilder.Entity("server.Entity.QrtzTrigger", b =>
                {
                    b.Property<string>("SchedName")
                        .HasMaxLength(120)
                        .HasColumnType("nvarchar(120)")
            ...
            modelBuilder.Entity("server.Entity.Role", b =>
                {
            ...
            modelBuilder.Entity("server.Entity.UserRole", b =>
                {
                    b.Property<int?>("UserId")
                        .HasColumnType("int")
                        .HasColumnName("user_id");
            ...
            modelBuilder.Entity("server.Entity.Job", b =>
                {
                    b.HasOne("server.Entity.User", null)
                        .WithMany("Jobs")
            ...
            modelBuilder.Entity("server.Entity.Log", b =>
                {
                    b.HasOne("server.Entity.Job", "Job")
                        .WithMany("Logs")
                        .HasForeignKey("JobId");

                    b.HasOne("server.Entity.User", "User")
                        .WithMany("Logs")
                        .HasForeignKey("UserId");
            ...
            modelBuilder.Entity("server.Entity.QrtzCronTrigger", b =>
                {
                    b.HasOne("server.Entity.QrtzTrigger", "QrtzTrigger")
                        .WithOne("QrtzCronTrigger")
                        .HasForeignKey("server.Entity.QrtzCronTrigger", "SchedName", "TriggerName", "TriggerGroup")
            ...
            modelBuilder.Entity("server.Entity.QrtzSimpleTrigger", b =>
                {
                    b.HasOne("server.Entity.QrtzTrigger", "QrtzTrigger")
                        ...
                        .HasForeignKey("server.Entity.QrtzSimpleTrigger", "SchedName", "TriggerName", "TriggerGroup")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("server.Entity.QrtzSimpropTrigger", b =>
                {
                    b.HasOne("server.Entity.QrtzTrigger", "QrtzTrigger")
                        ...
                        .HasForeignKey("server.Entity.QrtzSimpropTrigger", "SchedName", "TriggerName", "TriggerGroup")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("server.Entity.QrtzTrigger", b =>
                {
                    b.HasOne("server.Entity.QrtzJobDetail", "QrtzJobDetail")
            ...
            modelBuilder.Entity("server.Entity.UserRole", b =>
                {
                    b.HasOne("server.Entity.Role", "Role")
                        .WithMany()
